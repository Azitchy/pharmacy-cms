    ...
    <footer className="bg-white py-10 pb-6">
      <div className="mx-auto grid w-[min(1180px,calc(100%-32px))] gap-7 border-b border-emerald-950/5 pb-6 lg:grid-cols-[1.1fr_1.4fr]">
        ...
        <div className="grid gap-5 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mb-2 text-slate-500">Jn. Complex, Ward No. 22</p>
            <p className="mb-2 text-slate-500">Kathmandu, Nepal</p>
            <p className="mb-2 text-slate-500">+1 202-202-2022</p>
            <p className="text-slate-500">support@medicashop.com</p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto flex w-[min(1180px,calc(100%-32px))] items-center justify-between gap-4 pt-4 text-sm text-slate-400 max-md:flex-col max-md:items-start">
        ...
        <div className="flex gap-3">
          <span className="grid h-8 w-8 place-items-center rounded-full bg-emerald-50">f</span>
          <span className="grid h-8 w-8 place-items-center rounded-full bg-emerald-50">t</span>
          <span className="grid h-8 w-8 place-items-center rounded-full bg-emerald-50">i</span>
          <span className="grid h-8 w-8 place-items-center rounded-full bg-emerald-50">y</span>
        </div>
      </div>
    </footer>
  )
